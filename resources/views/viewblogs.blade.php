        ...
        <div class="grid grid-cols-3 gap-10 px-20 my-10">
            ...
            <div>
                ...
                <div class="flex items-center pt-5">
                    <img class="h-28 rounded-md" src="{{ asset('images/blogs/' . $blog->image) }}" alt="">
                    <div class="">
                        <div class="px-5">
                            <h1 class=" text-blue-600 font-bold">{{ $blog->title }}Title</h1>
                            <p class=" text-sm line-clamp-2">{{ $blog->description }}
                            </p>
                        </div>
