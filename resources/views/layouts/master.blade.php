...
<body class="dark:bg-slate-800">
    <section>
        ...
        <div class="cursor-pointer ">
            ...
            <a id="topbtn" href=""
                class="bg-indigo-900 fixed z-50 right-5 bottom-10  text-3xl rounded shadow text-white ">
        ...
        <nav id="smallNavbar" class=" block lg:hidden shadow-lg sticky top-0 bg-white z-50 px-10  ">
            ...
            <div class=" text-right mr-5 md:h-fit  hidden" id="menu">
                ...
                <a href=""
                    class="bg-indigo-700 rounded-xl text-white px-2 py-1  mb-6 hover:bg-red-600 duration-700">Get
                    IT
                    Support</a>
            </div>
        </nav>
        <nav id="bigNavbar"
            ...
            <a href=""
                class="bg-indigo-700 rounded-xl text-white px-2 py-1 mr-8 my-6 hover:bg-red-600 duration-700">Get IT
                Support</a>
        ...
        <div class="grid md:grid-cols-4 grid-cols-1  md:gap-10 gap-3 md:px-10 px-5 py-16 bg-[#312E81] text-gray-400">
            ...
            <div class="">
                <iframe
                    ...
                    width="40" height="300" style="border:none;overflow:hidden" scrolling="no"
