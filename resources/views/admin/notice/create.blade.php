    ...
    <div class="p-5">
        <form action="{{route('notice.store')}}" method="POST">
            ...
            <div>
                ...
                <input name="notice_text" type="text" class= " rounded md w-full my-2" >
                @error('notice_text')
            ...
            <div>
                ...
                <input name="notice_date" type="date" class= " rounded md w-full my-2">
                @error('notice_date')
                <p class="text-red-500 -mt-2 text-sm">* {{$message}}</p>
                @enderror
            </div>
            <div>
                ...
                <input name="priority" type="text" class= " rounded md w-full my-2" placeholder="Enter Priority">
                @error('priority')
                <p class="text-red-500 -mt-2 text-sm">* {{$message}}</p>
                @enderror
            </div>
