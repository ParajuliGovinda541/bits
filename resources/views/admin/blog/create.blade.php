        ...
        <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-20 px-20 ">
                <div>
                    ...
                    <input value="{{ old('links') }}" name="links" type="text" class= " rounded md w-full my-2"
                ...
                <div>
                    ...
                    <input value="{{ old('blog_date') }}" name="blog_date" type="date" class= " rounded md w-full my-2"
            ...
            <div class="px-20">
                ...
                <input value="{{ old('author') }}" name="author" type="text" class= " rounded md w-full my-2"
